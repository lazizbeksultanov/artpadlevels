        ...
        <div className="w-full">
            <button className="border-t border-r border-l border-black w-full" onClick={() => setActive(!active)}>
                <div className="flex items-center justify-between h-12 px-3 font-semibold w-full">
                    <span className="truncate text-2xl">{item.title}</span>
                    <svg className={`h-10 w-10 ease-in-out duration-300 ${active ? "rotate-180" : ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                         fill="#CD3ED0">
